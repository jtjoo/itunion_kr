import svgPaths from "./svg-n8hlk7jfyb";
import imgNavigation from "../assets/img/ITu_logo.svg";
import imgPanelImageContent from "../assets/img/ITu_character.svg";

function Tabs1({ className }: { className?: string }) {
  return (
    <div className={className || "content-stretch flex items-start relative shrink-0"} data-name="Tabs">
      <div className="content-stretch flex items-start overflow-clip relative shrink-0" data-name="Tabs">
        <div className="bg-[#d2d2d2] content-stretch flex items-center justify-center px-[12px] py-[4px] relative rounded-tl-[4px] rounded-tr-[4px] shrink-0" data-name="Tab">
          <div aria-hidden="true" className="absolute border-[#303030] border-b border-solid inset-0 pointer-events-none rounded-tl-[4px] rounded-tr-[4px]" />
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.4] not-italic relative shrink-0 text-[#303030] text-[16px] whitespace-nowrap">공지사항</p>
        </div>
        <div className="bg-white content-stretch flex items-center justify-center px-[12px] py-[4px] relative rounded-tr-[4px] shrink-0" data-name="Tab">
          <div aria-hidden="true" className="absolute border-[#d9d9d9] border-b border-r border-solid border-t inset-[-0.5px_-0.5px_-0.5px_0] pointer-events-none rounded-tr-[4.5px]" />
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.4] not-italic relative shrink-0 text-[#767676] text-[16px] whitespace-nowrap">갤러리</p>
        </div>
        <div className="content-stretch flex items-center justify-center px-[12px] py-[4px] relative rounded-tr-[4px] shrink-0" data-name="Tab">
          <div aria-hidden="true" className="absolute border-[#d9d9d9] border-b border-r border-solid border-t inset-0 pointer-events-none rounded-tr-[4px]" />
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.4] not-italic relative shrink-0 text-[#767676] text-[16px] whitespace-nowrap">성명/보도자료</p>
        </div>
      </div>
    </div>
  );
...
function Tabs() {
  return (
    <div className="bg-white content-stretch flex items-end pt-[20px] relative shrink-0 w-full" data-name="Tabs">
      <Tabs1 />
    </div>
  );
}
  ...
  return (
    <div className="absolute inset-[2.6%_83.85%_16.41%_0.5%]" data-name="e">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 34.4243 34.8241">
        <g id="e">
          <path d={svgPaths.p35bf6600} fill="url(#paint0_linear_1_183)" id="Vector" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_1_183" x1="11.5051" x2="22.8438" y1="2.00166" y2="31.9227">
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Logo Instagram">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g clipPath="url(#clip0_1_56)" id="Logo Instagram">
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Logo YouTube">
      <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24.0002">
        <g clipPath="url(#clip0_1_71)" id="Logo YouTube">
...
function Wrapper() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-[1200px]" data-name="Wrapper">
      ...
      <Tabs />
      <div className="bg-white opacity-80 relative shrink-0 w-full" data-name="Panel Image Content">
          ...
          <div className="content-stretch flex gap-[48px] items-start justify-center p-[64px] relative w-full">
            <div className="h-[350px] relative shrink-0 w-[484px]" data-name="Image">
              <div aria-hidden="true" className="absolute inset-0 pointer-events-none">
                ...
                <img alt="" className="absolute max-w-none object-contain opacity-20 size-full" src={imgPanelImageContent} />
              </div>
            </div>
      ...
      <div className="bg-white relative shrink-0 w-full" data-name="Card Grid Content List">
        <div className="flex flex-col items-center size-full">
          <div className="content-stretch flex flex-col gap-[48px] items-center p-[64px] relative w-full">
            <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 w-[113px]" data-name="Text Content Heading">
              <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.2] relative shrink-0 text-[#1e1e1e] text-[24px] tracking-[-0.48px] w-full">Heading</p>
              <div className="flex flex-col font-['Inter:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#757575] text-[20px] w-full">
                <p className="leading-[1.2]">Subheading</p>
              </div>
                ...
                <div className="content-start flex flex-wrap gap-[24px] items-start min-w-[inherit] p-[24px] relative w-full">
                  ...
                  <div className="content-stretch flex flex-[1_0_0] flex-col gap-[16px] items-start min-h-px min-w-[160px] relative" data-name="Body">
                    <div className="content-stretch flex flex-col gap-[8px] items-start not-italic relative shrink-0 w-full" data-name="Text">
                      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[1.2] relative shrink-0 text-[#1e1e1e] text-[24px] tracking-[-0.48px] w-full">Title</p>
                      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.4] relative shrink-0 text-[#757575] text-[16px] w-full">{`Body text for whatever you’d like to say. Add main takeaway points, quotes, anecdotes, or even a very very short story. `}</p>
                    </div>
                    <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full" data-name="Button Group">
                      <div className="bg-[#2c2c2c] relative rounded-[8px] shrink-0" data-name="Button">
                        <div className="content-stretch flex gap-[8px] items-center justify-center overflow-clip p-[12px] relative rounded-[inherit]">
                          <p className="font-['Inter:Regular',sans-serif] font-normal leading-none not-italic relative shrink-0 text-[#f5f5f5] text-[16px] whitespace-nowrap">Button</p>
                        </div>
                        <div aria-hidden="true" className="absolute border border-[#2c2c2c] border-solid inset-0 pointer-events-none rounded-[8px]" />
                      </div>
                    </div>
...
export default function NewsStatementPressDesktop() {
  return (
    <div className="bg-[#666] content-stretch flex flex-col items-center px-[120px] relative size-full" data-name="News - Statement_Press - Desktop">
      <Wrapper />
    </div>
  );
}