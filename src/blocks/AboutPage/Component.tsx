...
export function AboutPageBlock() {
  return (
    <div className="flex flex-col items-center w-full">
      ...
      <section className="w-full bg-[#f5f5f5]">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-8 md:px-16 py-10 sm:py-16">
          ...
          {/* Org Chart — Desktop (absolute positioning matching Figma Diagram) */}
          <div className="hidden md:block relative w-full" style={{ height: 920 }}>
            ...
            <div className="absolute left-1/2 -translate-x-1/2 top-[53px] bg-[#323232] flex flex-col items-center justify-center overflow-clip px-5 py-2.5 rounded-full shadow-[2px_2px_8px_0px_rgba(0,0,0,0.96)] w-[300px] h-[80px]">
              <p className="font-['Inter','Noto_Sans_KR',sans-serif] text-[24px] leading-[1.2] tracking-[-0.48px] text-center text-white">
                총회
              </p>
              <p className="font-['Inter','Noto_Sans_KR',sans-serif] text-[16px] leading-[1.4] text-center text-white">
                최고 의사 결정 기구
              </p>
            </div>

            {/* Connector: Board → Directors (66px line) */}
            ...
            {/* Horizontal line: Directors → Election */}
            ...
            {/* Connector: Directors → Congress (83px line) */}
            ...
            {/* Connector: Congress → Branches (83px line) */}
