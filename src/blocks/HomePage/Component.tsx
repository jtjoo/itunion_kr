      ...
      <section className="w-full bg-[#d9d9d9]">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-8 md:px-16 pt-12 sm:pt-16 pb-10 sm:pb-[74px]">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-16 py-2.5">
            {[
              {
                icon: <Shield size={80} strokeWidth={1.5} className="text-[#374957]" />,
                title: '노동권 보호',
                desc: '안전하게 노동할 권리를 보장하기 위한 방패가 되어드립니다.',
              },
              {
                icon: <Briefcase size={80} strokeWidth={1.5} className="text-[#374957]" />,
                title: '노동환경 개선',
                desc: '더 안전하고 건강한 근무 환경 조성을 위해 노력합니다.',
              },
              {
                icon: <Smile size={80} strokeWidth={1.5} className="text-[#374957]" />,
                title: '함께하는 공동체',
          ...
          <div className="relative">
            ...
            {[
              ...
              },
              {
                ...
                desc: '서울시의회 개발자 폭행사건 대응, 출퇴근 기록을 증명하기 위한 "야근시계"앱 개발 및 배포, 다단계 하도급을 금지하는 SW산업진흥법 개정안 추진 등으로 IT산업의 노동자를 위한 본격적인 권리 쟁취를 위해 활동해왔습니다.',
                color: '#0083ff',
                side: 'left' as const,
              },
              {
              ...
              },
              {
                year: '2020-2024',
                title: '게임산업 노동환경 개선',
                desc: '2016년 게임산업계의 연이은 게임 노동자 사망사건에 따라 야근은 2급 발암물질이라는 슬로건과 함께 게임 업계의 장시간 노동 실태를 고발하고 전수 조사를 이끌어내는 등 실질적 변화를 도모했습니다.',
                color: '#0083ff',
                side: 'left' as const,
              },
              {
